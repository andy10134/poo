...
class FechaHora:
    ...
    def __radd__(self, otroTiempo):
        ...
        if(type(otroTiempo) is Hora):
            hora += otroTiempo.getHora()
    ...
    def __sub__(self, dia):
        ...
        if( dia <= 0):
            ...
            if(mes <= 0):
                ...
                mes = 12
                anio -= 1            
        return FechaHora(dia,mes,anio, self.getHora(), self.getMinutos(), self.getSegundos())

...
if __name__ == '__main__':
    ...
    r = F.FechaHora()  # inicilizar día, mes, año con 1/1/2020, y hora, minutos y
    # segundos con 0h, 0m, 0s.

    r1 = F.FechaHora(d, mes, a)  # inicializar con 0h 0m 0s
    r2 = F.FechaHora(d, mes, a, h, m, s)
    r.Mostrar()
    r1.Mostrar()
    r2.Mostrar()

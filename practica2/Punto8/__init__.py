...
# la interfaz del Tesorero, que solamente puede acceder a los gastos que la empresa tiene en concepto de sueldos, para ello, dado un número de documento, podrá consultar el gasto de sueldos para el empleado al que pertenece dicho número de documento.
#
# La interfaz del Gerente, permite modificar el sueldo básico de un empleado de planta, 
# el valor que se paga por hora de un empleado contratado o el valor que se paga por viático 
# de un empleado externo; para ello debe proveerse el número de documento del empleado, 
# y el valor que corresponda según lo que se quiera modificar.
#

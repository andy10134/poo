...
if __name__ == "__main__":
    ...
    while not salir:
        ...
        print("0 Salir")
        print(
            "1- Registrar horas: Ingresar el DNI de un empleado y la cantidad",
            " de horas trabajadas hoy e incrementar la cantidad de las horas",
            " trabajadas del empleado."
        )
        print(
            "2- Total de tarea: Dada una tarea mostrar el monto",
            " a pagar para ella. Solo se consideran las tareas que",
            " no han finalizado."
        )
        print(
            "3- Ayuda: La empresa dará una ayuda solidaria",
        ...
        print(
            "4- Calcular sueldo: Mostrar nombre, teléfono y sueldo",

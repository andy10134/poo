...
#
#De cada vehículo desea registrar el modelo (ej. Palio, Focus, etc.),
#  cantidad de puertas, color y el precio base de venta. Los vehículos nuevos son de una misma marca,
#  en cambio los usados pueden ser de cualquier marca, por ello este también es un dato que debe registrar.
#
...
#
#El importe de venta de cada vehículo se calcula en función del precio base y de sus características.
# Para ello se deben considerar las siguientes reglas de negocio:
#
#    Importe de venta del vehículo usado es el precio base, menos el 1% por cada año de antigüedad 
# (año actual – año del vehículo), menos el 2% si el kilometraje supera los 100.000. Ambos porcentajes se calculan 
# sobre el precio base.
#    Importe de venta del vehículo nuevo es el precio base, más 10% por gastos de patentamiento, mas 2% si es full. 
...
#
#La colección de vehículos debe implementarse usando una Lista definida por el programador,
#  donde los nodos deberán almacenar vehículos.
#
#La Lista deberá proveer los métodos y atributos necesarios para que sea un iterable, e implementar la 
# interface del ejercicio anterior.
#

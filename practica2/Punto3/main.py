# Con su grupo de trabajo deben desarrollar una aplicación para manejar
# las inscripciones de las personas a los talleres de capacitación que se
# dictan en una escuela complementaria. Al momento de la inscripción la persona
# puede o no abonar el costo del taller.
...
# c-Defina una clase colección (manejador), tipo arreglo para almacenar
# instancias de la clase Inscripcion.
# e- Implementar un programa que permita:
# 1.Cargar los datos de los talleres en la clase TallerCapacitacion a partir
# de los datos registrados en el archivo.
...
# ser actualizada.
# 3.Consultar inscripción: Ingresar el DNI de una persona, si está inscripta
# mostrar el nombre del taller en el que se inscribió y el monto que adeuda.
# 4.Consultar inscriptos: Ingresar el identificador de un taller y listar los
# datos de los alumnos que se inscribieron en él.
# 5.Registrar pago: Ingresar el DNI de una persona y registrar el pago
# (dar al atributo pago el valor True).
